"use strict";
var transparent = !0, transparentDemo = !0,
    fixedTop = !1, navbar_initialized = !1, backgroundOrange = !1, sidebar_mini_active = !1, toggle_initialized = !1,
    $html = $("html"), $body = $("body"), $navbar_minimize_fixed = $(".navbar-minimize-fixed"),
...
var blackDashboard = {
    misc: {navbar_menu_visible: 0}, checkScrollForTransparentNavbar: debounce(function () {
        ...
        0 != $(".sidebar-mini").length, $(".minimize-sidebar").click(function () {
            1 == sidebar_mini_active ? ($body.toggleClass("sidebar-mini"), blackDashboard.showSidebarMessage("Sidebar mini deactivated...")) : ($body.addClass("sidebar-mini"), sidebar_mini_active = !0, blackDashboard.showSidebarMessage("Sidebar mini activated..."));
